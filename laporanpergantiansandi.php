...
if ($startDate && $endDate) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_pergantian_sandi WHERE tanggal_melapor BETWEEN '$startDate' AND DATE_ADD('$endDate', INTERVAL 1 DAY)");
} else {
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_pergantian_sandi");
}
...
<div class="col-lg-10 mt-2">
    <div class="card">
        <div class="card-header">
            Halaman Laporan Pergantian Sandi
        </div>
        <div class="card-body">
            ...
            <?php
            if (empty($result)) {
                echo "Data Laporan User Pergantian Sandi tidak ada";
            } else {
            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn btn-info btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView<?php echo $row['id_laporan_ganti_sandi'] ?>"><i class="bi bi-eye"></i> View</button>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Modal View User Laporan Ganti Sandi -->
                                <div class="modal fade" id="ModalView<?php echo $row['id_laporan_ganti_sandi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <!-- Akhir Modal User Laporan Ganti Sandi View -->
                            <?php
                            }
                            ?>
                        </tbody>
                ...
                <div id="printForm" class="d-none">
                    ...
                    <h4>Data User Pergantian Sandi</h4>
                    ...
                    <table class="table table-hover" style="border: 1px solid black; border-collapse: collapse;">
                        <thead>
                            <tr style="border: 1px solid black;">
                                ...
                                <th scope="col" style="border: 1px solid black;">Nama Wifi</th>
                                <th scope="col" style="border: 1px solid black;">Password Baru</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="border: 1px solid black;">
                                    ...
                                    <td style="border: 1px solid black;"><?php echo $row['nama_wifi'] ?></td>
                                    <td style="border: 1px solid black;"><?php echo $row['password_baru'] ?></td>
