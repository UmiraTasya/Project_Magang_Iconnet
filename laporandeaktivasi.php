...
if ($startDate && $endDate) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_deaktivasi WHERE tanggal_melapor BETWEEN '$startDate' AND DATE_ADD('$endDate', INTERVAL 1 DAY)");
} else {
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_deaktivasi");
}
...
<div class="col-lg-10 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php
            if (empty($result)) {
                echo "Data Laporan User Deaktivasi tidak ada";
            } else {
            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn btn-info btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView<?php echo $row['id_laporan_deaktivasi'] ?>"><i class="bi bi-eye"></i> View</button>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Modal View User Laporan Deaktivasi -->
                                <div class="modal fade" id="ModalView<?php echo $row['id_laporan_deaktivasi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <table class="table table-hover" style="border: 1px solid black; border-collapse: collapse;">
                        <thead>
                            <tr style="border: 1px solid black;">
                                ...
                                <th scope="col" style="border: 1px solid black;">Alasan Deaktivasi</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="border: 1px solid black;">
                                    ...
                                    <td style="border: 1px solid black;"><?php echo $row['alasan_deaktivasi'] ?></td>
