...
if ($startDate && $endDate) {
    ...
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_gangguan WHERE tanggal_melapor BETWEEN '$startDate' AND DATE_ADD('$endDate', INTERVAL 1 DAY)");
} else {
    $query = mysqli_query($conn, "SELECT * FROM tb_laporan_gangguan");
}
...
<div class="col-lg-10 mt-2">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php
            if (empty($result)) {
                echo "Data Laporan Gangguan tidak ada";
            } else {
            ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="assets/img/<?php echo $row['foto'] ?>" alt="Foto ONT" width="100"></td>
                                    <td><?php echo $row['status'] ?></td>
                                    <td><?php echo $row['tanggal_perbaikan'] ?></td>
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn btn-info btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView<?php echo $row['id_laporan_gangguan'] ?>"><i class="bi bi-eye"></i> View</button>
                                        </div>
                                    </td>
                                </tr>

                                <!-- Modal View User Gangguan -->
                                <div class="modal fade" id="ModalView<?php echo $row['id_laporan_gangguan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <table class="table table-hover" style="border: 1px solid black; border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="border: 1px solid black;">Foto ONT</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black;"><img src="assets/img/<?php echo $row['foto'] ?>" alt="Foto ONT" width="50"></td>
...
<style>
    @media print {
        ...
        #printForm td {
            ...
            padding: 8px;
            /* Tambahkan padding agar konten terlihat lebih baik saat dicetak */
        }
        ...
        #printForm img {
            ...
            margin: 0 auto 20px;
            /* Atur margin bawah gambar cetak */
        }
    }
</style>
